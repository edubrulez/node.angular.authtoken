...
module.exports = function(passport, config) {
    ...
    passport.use(new BasicStrategy(
        function(username, password, done) {
          console.log('BaS: clientKey: %s, clientSecret: %s', username, password);
...
//        console.log('BaS: clientKey: %s, clientSecret: %s', clientKey, clientSecret);
//        OAuthClient.findOne({ clientKey: clientKey, clientSecret: clientSecret }, function (err, client) {
//            console.log('BaS: clientKey: %s, clientToken: %s, err: %s, client: %s', clientKey, clientSecret, err, client);
//            if (err) return done(err);
//            if (!client) return done(null, false);
//            return done(null, client);
//        });
//    }));
    ...
    passport.use(new BearerStrategy(function (accessToken, done) {
        ...
        AccessToken.findOne({ token: accessToken }, function (err, token) {
            ...
            //console.log('BeS: userId: %s', token.userId);
